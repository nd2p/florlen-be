...
const ORDER_STATUS = Object.freeze({
  ...
  AWAITING_REMAINING_PAYMENT: 'awaiting_remaining_payment',
...
const VALID_TRANSITIONS = Object.freeze({
  ...
  [ORDER_STATUS.IN_PRODUCTION]: [
    ...
    ORDER_STATUS.AWAITING_REMAINING_PAYMENT,
  ...
  [ORDER_STATUS.AWAITING_REMAINING_PAYMENT]: [ORDER_STATUS.READY_TO_SHIP],
